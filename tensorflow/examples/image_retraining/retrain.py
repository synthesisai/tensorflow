...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_graph','~/experiments/training_'+timestr+'/output_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--output_labels',
      type=str,
      default='~/experiments/training_'+timestr+'/output_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='~/experiments/training_'+timestr+'/retrain_logs',
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='~/experiments/training_'+timestr+'/bottleneck',
